      ...
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="intro.jsp">ACC소개</a>
            </li>
            <li class="nav-item">
              <a class="nav-link disabled" href="playground.jsp">놀이터</a>
            </li>
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown01">
                <a class="dropdown-item" href="attendanceInput.jsp">출결입력</a>
                <a class="dropdown-item" href="attendanceCheck.jsp">출석확인</a>
                <a class="dropdown-item" href="progress.jsp">진도표</a>
